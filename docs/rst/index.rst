.. Container Integrity Measurement Agent documentation master file, created by
   sphinx-quickstart on Wed Apr  3 02:08:24 2024.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to Container Integrity Measurement Agent's documentation!
================================================================
...
From the perspective of tenant's workload, ``CIMA`` will expose the `Evidence API <https://github.com/cc-api/evidence-api>` as the unified interfaces across diverse trusted foundations like ``RTMR+TDMR+CCEL`` and ``PCR+TPM2``. The definitions and structures follows standard specifications like:
...
.. image:: cima-architecture-high-level.png
   :alt: CIMA architecture high level
   :align: center
...
.. image:: cima-landing-confidential-cluster.png
   :alt: CIMA landing confidential cluster
   :align: center
...
.. image:: cc-full-measurement-tdreport.png
   :alt: CIMA full measurement TDREPORT
   :align: center
...
``CIMA`` includes several micro-services as BaaS(Backend as a Service) to provides cloud native measurement, then exposes ``Evidence API`` via cloud native SDK:
